...
$base_url = "http://localhost/AttendanceManagement/";
...
if (!function_exists('load_grade_list')) {
...
if (!function_exists('get_attendance_percentage')) {
...
if (!function_exists('Get_student_grade_name')) {
...
if (!function_exists('Get_student_teacher_name')) {
