...
include('C:/xampp/htdocs/AttendanceManagement/admin/database_connection.php');
session_start();
$output = '';
if(isset($_POST["action"]))
{
 ...
 if($_POST["action"] == "edit_fetch")
 {
  ...
  if($statement->execute())
  {
   ...
   foreach($result as $row)
   {
    $array['teacher_name'] = $row["teacher_name"];
    $array['teacher_address'] = $row['teacher_address'];
    $array['teacher_emailid'] = $row['teacher_emailid'];
    $array['teacher_qualification'] = $row['teacher_qualification'];
    $array['teacher_doj'] = $row['teacher_doj'];
    $array['teacher_image'] = $row['teacher_image'];
    $array['teacher_grade_id'] = $row['teacher_grade_id'];
    $array['teacher_id'] = $row['teacher_id'];
   $output = $array;
  }
   echo json_encode($output);
  }
