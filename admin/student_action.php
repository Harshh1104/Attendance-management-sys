...
if(isset($_POST["action"]))
{
 ...
 if($_POST["action"] == "edit_fetch")
 {
  ...
  if($statement->execute())
  {
   ...
   foreach($result as $row)
   {
    $array['student_name'] = $row["student_name"];
    $array['student_roll_number'] = $row['student_roll_number'];
    $array['student_dob'] = $row['student_dob'];
    $array['student_grade_id'] = $row['student_grade_id'];
