...
include('C:/xampp/htdocs/AttendanceManagement/admin/header.php');
...
<footer>
    <div>
      <br><br>
      &nbsp;&nbsp;&copy;Copyright @Harsh Verma. Developed for DBMS minor project. <br><br>
    </div>
  </footer> 
</body>
</html>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <div>
            <input type="text" name="from_date" id="from_date" class="form-control input-daterange" placeholder="From Date" readonly />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <div>
            <input type="text" name="attendance_date" id="attendance_date" class="form-control input-daterange" placeholder="Select Date" readonly />
